                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="font-medium text-slate-900 dark:text-white">{{ $customer->name ?: 'Unnamed' }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="px-4 py-3 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form method="POST"
                                            ...
                                            @method('DELETE')
                                            <button type="button"
                                                    data-customer-name="{{ addslashes($customer->name ?: 'Unnamed') }}"
...
<script>
    function confirmDeleteCustomer(btn) {
        var customerName = btn.getAttribute('data-customer-name') || 'this customer';
        var form = btn.closest('form');

        Swal.fire({
            icon: 'warning',
            title: 'Delete Customer?',
            html: 'You are about to delete <strong>' + customerName + '</strong>.<br>This action <u>cannot</u> be undone.',
            showCancelButton: true,
            confirmButtonColor: '#dc2626',
            cancelButtonColor: '#64748b',
            confirmButtonText: '<svg xmlns="http://www.w3.org/2000/svg" class="inline-block h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"/></svg> Yes, Delete',
