    ...
    <div class="space-y-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500">{{ __('Track workloads, skills, and assignment availability.') }}</p>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function loadTechnicians() {
                ...
                rows.innerHTML = list.map(function (tech) {
                    ...
                    `;
                }).join('') || '<tr><td class="px-4 py-6 text-center text-sm text-slate-500" colspan="4">{{ __('No technicians found.') }}</td></tr>';
            }
