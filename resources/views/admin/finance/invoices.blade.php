...
@section('content')
    <div class="space-y-6">
        <div>
            ...
            <p class="text-sm text-slate-500">Review repair invoices and payment status.</p>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            async function loadInvoices() {
                ...
                if (!response.ok) {
                    rows.innerHTML = '<tr><td class="px-4 py-6 text-center text-sm text-slate-500" colspan="5">Unable to load invoices.</td></tr>';
                    return;
                }
                ...
                rows.innerHTML = list.map(function (invoice) {
                    ...
                    `;
                }).join('') || '<tr><td class="px-4 py-6 text-center text-sm text-slate-500" colspan="5">No invoices found.</td></tr>';
            }
