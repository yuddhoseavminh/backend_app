...
use App\Http\Controllers\Api\RepairQcController;
...
Route::prefix('auth')->group(function () {
    ...
    Route::post('phone/verify', [PhoneAuthController::class, 'verifyOtp']);
...
Route::middleware('admin')->group(function () {
    ...
    Route::get('product-types', [ProductTypeController::class, 'index'])->middleware('permission:view_product_master,view_product');
    Route::post('product-types', [ProductTypeController::class, 'store'])->middleware('permission:create_product_master');
    Route::patch('product-types/{productType}', [ProductTypeController::class, 'update'])->middleware('permission:update_product_master');
    Route::delete('product-types/{productType}', [ProductTypeController::class, 'destroy'])->middleware('permission:delete_product_master');
    ...
    Route::get('admin/customers/search', [AdminCustomerController::class, 'search'])->middleware('permission:view_customer');
    Route::post('admin/customers', [AdminCustomerController::class, 'store'])->middleware('permission:create_customer');
    Route::get('repairs', [RepairRequestController::class, 'index'])->middleware('permission:view_repair');
    Route::post('repairs/{repair}/intake', [RepairIntakeController::class, 'store'])->middleware('permission:update_repair');
    Route::get('repairs/{repair}/intake', [RepairIntakeController::class, 'show'])->middleware('permission:view_repair');
    Route::post('repairs/{repair}/assign-technician', [RepairRequestController::class, 'assignTechnician'])->middleware('permission:update_repair');
    Route::post('repairs/{repair}/auto-assign', [RepairRequestController::class, 'autoAssign'])->middleware('permission:update_repair');
    Route::post('repairs/{repair}/diagnostic', [RepairDiagnosticController::class, 'store'])->middleware('permission:update_repair');
    Route::post('repairs/{repair}/quotation', [RepairQuotationController::class, 'store'])->middleware('permission:update_repair');
    Route::post('repairs/{repair}/status', [RepairRequestController::class, 'updateStatus'])->middleware('permission:update_repair');
    Route::post('repairs/{repair}/warranty', [RepairWarrantyController::class, 'store'])->middleware('permission:update_repair');
    Route::post('repairs/{repair}/qc', [RepairQcController::class, 'store'])->middleware('permission:update_repair');
    Route::get('repairs/{repair}/qc', [RepairQcController::class, 'show'])->middleware('permission:view_repair');
    Route::post('repairs/{repair}/invoice', [RepairInvoiceController::class, 'store'])->middleware('permission:update_repair');
    ...
    Route::put('technicians/{technician}', [TechnicianController::class, 'update'])->middleware('permission:update_technician');
    Route::patch('technicians/{technician}', [TechnicianController::class, 'update'])->middleware('permission:update_technician');
    Route::delete('technicians/{technician}', [TechnicianController::class, 'destroy'])->middleware('permission:delete_technician');
